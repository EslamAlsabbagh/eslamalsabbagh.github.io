...
class TeamMissingpunchRequestsPage extends StatelessWidget {
  const TeamMissingpunchRequestsPage({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider<UserMissingpunchRequestsBloc>(
      ...
      child: UserMissingpunchRequestsContent(sourceType: RequestSourceType.teamRequests),
    );
  }
}
