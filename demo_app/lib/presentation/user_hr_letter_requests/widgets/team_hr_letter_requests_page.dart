...
class TeamHrLetterRequestsPage extends StatelessWidget {
  const TeamHrLetterRequestsPage({super.key});
      ...
      create:
          (context) =>
              UserHrLetterRequestsBloc(context.read<HrLetterRequestRepo>())
                ..add(loadHrLetterRequestsEvent(userId, HrLetterRequestSourceType.teamRequests)),
      child: const UserHrLetterRequestsContent(sourceType: HrLetterRequestSourceType.teamRequests),
    );
  }
}
