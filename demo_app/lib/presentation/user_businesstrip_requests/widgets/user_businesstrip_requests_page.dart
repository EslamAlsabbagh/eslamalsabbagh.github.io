...
class UserBusinesstripRequestsPage extends StatelessWidget {
  const UserBusinesstripRequestsPage({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider<UserBusinesstripRequestsBloc>(
      ...
      child: UserBusinesstripRequestsContent(sourceType: RequestSourceType.myRequests),
    );
  }
}
