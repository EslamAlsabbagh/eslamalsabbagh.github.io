...
class TeamRequestsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<UserRequestsBloc>(
      create:
          ...
          )..add(loadRequestsEvent(context.read<UserBloc>().state.user?.id ?? 0, RequestSourceType.teamRequests)),
      child: UserRequestsContent(sourceType: RequestSourceType.teamRequests),
    );
  }
}
