...
class LeaveCancellationRequestModel {
  final int? id;
  ...
  // Original leave request details for display
  final DateTime? originalLeaveFrom;
  final DateTime? originalLeaveTo;
  final String? originalLeaveType;
  final String? originalLeaveStatus;
  final double? originalNumberOfDays;
  ...
  String getLocalizedOriginalLeaveType(BuildContext context) {
    switch (originalLeaveType) {
      case 'Annual':
  ...
  LeaveCancellationRequestModel({
    this.id,
    required this.originalLeaveRequestId,
    ...
    this.userHireDate,
    this.declineReason,
    this.requestType = 'leave_cancellation',
    this.cancelled,
    this.removed,
    this.removedN1,
    this.n1ApprovalDate,
    ...
    this.hrEnglishName,
    this.hrArabicName,
    this.originalLeaveFrom,
    this.originalLeaveTo,
    this.originalLeaveType,
    this.originalLeaveStatus,
    this.originalNumberOfDays,
  });

  factory LeaveCancellationRequestModel.fromJson(Map<String, dynamic> json) {
    return LeaveCancellationRequestModel(
      id: json['id'],
      originalLeaveRequestId: json['original_leave_request_id'],
      userId: json['user_id'],
      reason: json['reason'],
      status: json['status'],
      ...
      // Original leave request details from joined query
      originalLeaveFrom: DateTime.tryParse(json['original_leave_request']?['date_from']),
      originalLeaveTo: DateTime.tryParse(json['original_leave_request']?['date_to']),
      originalLeaveType: json['original_leave_request']?['leave_type'],
      originalLeaveStatus: json['original_leave_request']?['status'],
      originalNumberOfDays: json['original_leave_request']?['num_of_days']?.toDouble(),
    );
  }

  Map<String, dynamic> toJson() {
    return {
      'original_leave_request_id': originalLeaveRequestId,
      'user_id': userId,
      'reason': reason,
      'n1_code': n1Code,
      'n2_code': n2Code,
  ...
  LeaveCancellationRequestModel copyWith({
    int? id,
    int? originalLeaveRequestId,
    int? userId,
    String? reason,
    String? status,
    DateTime? createdAt,
    ...
    String? hrArabicName,
    DateTime? originalLeaveFrom,
    DateTime? originalLeaveTo,
    String? originalLeaveType,
    String? originalLeaveStatus,
    double? originalNumberOfDays,
  }) {
    return LeaveCancellationRequestModel(
      id: id ?? this.id,
      originalLeaveRequestId: originalLeaveRequestId ?? this.originalLeaveRequestId,
      ...
      originalLeaveFrom: originalLeaveFrom ?? this.originalLeaveFrom,
      originalLeaveTo: originalLeaveTo ?? this.originalLeaveTo,
      originalLeaveType: originalLeaveType ?? this.originalLeaveType,
      originalLeaveStatus: originalLeaveStatus ?? this.originalLeaveStatus,
